...
func TestCapacityQuotaAutoscaling(t *testing.T) {
	var cq *cqv1beta1.CapacityQuota
	...
	cqFeature := features.New("CapacityQuota").
		Setup(func(ctx context.Context, t *testing.T, cfg *envconf.Config) context.Context {
			...
			cq = cqtest.NewCapacityQuota(
				...
				cqtest.WithLimits(cqv1beta1.ResourceList{
					cqv1beta1.ResourceNodes: resource.MustParse("3"),
				}),
			)
		...
		Teardown(func(ctx context.Context, t *testing.T, cfg *envconf.Config) context.Context {
			...
			cqList := &cqv1beta1.CapacityQuotaList{}
		...
		Assess("scale up succeeds when quota is not exceeded", func(ctx context.Context, t *testing.T, cfg *envconf.Config) context.Context {
			...
			wantUsage := cqv1beta1.ResourceList{
		...
		Assess("all pods get scheduled once quota is increased", func(ctx context.Context, t *testing.T, cfg *envconf.Config) context.Context {
			...
			cq.Spec.Limits.Resources[cqv1beta1.ResourceNodes] = resource.MustParse("8")
...
func capacityQuotaUsageUpdated(client klient.Client, cq *cqv1beta1.CapacityQuota, usage cqv1beta1.ResourceList) wait2.ConditionWithContextFunc {
