...
func TestExist(t *testing.T) {
	...
	assert.True(t, agentPool.Exist(context.TODO()))
}
func TestCreate(t *testing.T) {
	agentPool := &VMPool{}

	nodeGroup, err := agentPool.Create(context.TODO())
...
func TestDelete(t *testing.T) {
	...
	err := agentPool.Delete(context.TODO())
...
func TestAutoprovisioned(t *testing.T) {
	...
	assert.False(t, agentPool.Autoprovisioned(context.TODO()))
}
...
func TestGetOptions(t *testing.T) {
	...
	options, err := agentPool.GetOptions(context.TODO(), defaults)
...
func TestDecreaseTargetSize(t *testing.T) {
	...
	err := agentPool.DecreaseTargetSize(context.TODO(), 1)
	assert.Nil(t, err)
}
...
func TestDebug(t *testing.T) {
	...
	assert.Equal(t, expectedDebugString, agentPool.Debug(context.TODO()))
}
func TestTemplateNodeInfo(t *testing.T) {
	...
	nodeInfo, err := ap.TemplateNodeInfo(context.TODO())
...
func TestAtomicIncreaseSize(t *testing.T) {
	...
	targetSize, err := ap.TargetSize(context.TODO())
	assert.NoError(t, err)
	assert.Equal(t, 3, targetSize)

	err = ap.AtomicIncreaseSize(context.TODO(), 1)
	assert.NoError(t, err)
...
func TestVMsPoolIncreaseSize(t *testing.T) {
	...
	err3 := ap.IncreaseSize(context.TODO(), 1)
...
func TestDeleteVMsPoolNodes_Failed(t *testing.T) {
	...
	// failure case
	deleteErr := ap.DeleteNodes(context.TODO(), []*apiv1.Node{node})
...
func TestDeleteVMsPoolNodes_Success(t *testing.T) {
	...
	mockAgentpoolclient.EXPECT().BeginDeleteMachines(
		...
		gomock.Any(), gomock.Any()).Return(fakePoller, nil)
	node := newVMsNode(0)
	derr := ap.DeleteNodes(context.TODO(), []*apiv1.Node{node})
...
func TestVMsPoolNodesReportsProvisioningState(t *testing.T) {
	...
	instances, err := ap.Nodes(context.TODO())
	assert.NoError(t, err)
...
func TestDeleteVMsPoolNodesProactivelyMarksDeletion(t *testing.T) {
	...
	assert.NoError(t, ap.DeleteNodes(context.TODO(), []*apiv1.Node{deletingNode}))
